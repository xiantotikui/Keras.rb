...
keras_import(['Datasets', 'Utils', 'Model', 'Convolutional', 'Core', 'Pooling', 'Optimizers'])
...
y_train = Keras::Utils::to_categorical array[0][1], num_classes: num_classes
x_test = array[1][0].astype('float32') / 255
y_test = Keras::Utils::to_categorical array[1][1], num_classes: num_classes
...
model.add(Keras::Core.dense(num_classes))
